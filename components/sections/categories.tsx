...
const FALLBACK_TILES = [
	{ name: "Botanicals", slug: "botanicals", image: "/scraped-2.png", caption: "Skin & body" },
	{ name: "Personal Care", slug: "personal-care", image: "/scraped-0.png", caption: "Daily rituals" },
	{ name: "Home & Living", slug: "home-living", image: "/scraped-4.png", caption: "Calm interiors" },
	{ name: "Atelier Goods", slug: "atelier-goods", image: "/scraped-5.png", caption: "Made by hand" },
];
	...
	const tiles =
		collections.data.length >= 4
			? collections.data.slice(0, 4).map((c, i) => ({
					name: c.name,
					slug: c.slug,
					image: FALLBACK_TILES[i]?.image ?? "/scraped-0.png",
